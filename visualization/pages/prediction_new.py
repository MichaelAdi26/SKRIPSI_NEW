...
# register_page(__name__, path='/prediction_new')
...
#             xaxis_title='Date',  # label sumbu X
#             yaxis_title='Electricity Demand (KWh)',  # label sumbu Y
#             yaxis=dict(showgrid=False, color='white', range=[0, 800]),
#             legend=dict( x=1, y=0.2, xanchor='right', yanchor='top', bgcolor='black'), 
#             margin=dict(l=40, r=40, t=80, b=40),  # opsional: margin yang seimbang
#             plot_bgcolor='black',      # latar belakang area plotting
#             paper_bgcolor='black',     # latar belakang keseluruhan canvas
#             font=dict(color='white')   # warna teks umum
#         )
